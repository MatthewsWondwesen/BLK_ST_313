  ...
  units: [
    {
      id: "unit-1",
      number: "Unit 1",
      title: "Mothers, Daughters, and Family Wounds",
      shortLabel: "Family Wounds",
      description:
        "This unit looks at family relationships, especially between mothers, daughters, and children. Family can be a place where people feel loved and protected. It can also be a place where pain gets passed down quietly. This unit does not try to blame mothers or daughters. Instead, it asks how Black women survive inside families shaped by silence, trauma, and unfair expectations.",
      works: [
        {
          id: "lorde-man-child",
          type: "Essay",
          title: "Man Child: A Black Lesbian Feminist's Response",
          author: "Audre Lorde",
          year: "1979",
          description:
        ...
        },
        {
          ...
          author: "Camille Billops and James Hatch",
          year: "1982",
          description:
        ...
        },
        {
          ...
          type: "Song",
          title: "On Children",
          author: "Sweet Honey in the Rock",
          year: "1988",
          album: "Breaths",
          description:
    ...
    },
    {
      id: "unit-2",
      number: "Unit 2",
      title: "Community Care and Healing",
      shortLabel: "Community Care",
      description:
        "This unit moves outside the private family and looks at care in the larger community. Black women often care for friends, neighbors, movements, and people who may not be related to them by blood. This unit asks what that kind of care costs. It also asks what healing looks like when the healer is wounded too.",
      works: [
        {
          id: "salt-eaters",
          type: "Novel",
    ...
    },
    {
      ...
      assignmentDetails: {
        goal:
          "The goal is not to summarize the works. Students should slow down and focus on specific details. They might choose a quote, a scene, a lyric, an image, a character, or a symbol. Then they should explain what that detail teaches us about Black women's care. Does the work show care as love? Does it show care as pressure? Does it show care as healing? Does it show care as something that hurts?",
        reflection:
          "This assignment helps students practice reading different kinds of art together. A novel, a song, and a film can all make arguments. They can all show what Black women were feeling, questioning, and trying to survive. By the end, students should be able to explain how Black women in the 1970s and 1980s used creativity to tell the truth about motherhood. The final reflection should answer one larger question: what do these works teach us about care as something powerful, complicated, and human?",
        requirements: [
          "Choose three works from the course",
          "One written text, one film or visual artwork, one song",
          "4–5 page analytical paper",
          "Focus on specific details, not summary",
        ],
      },
    },
  ],
